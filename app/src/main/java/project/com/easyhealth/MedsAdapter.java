 ...
 */
public class MedsAdapter extends RecyclerView.Adapter<MedsAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public MedsAdapter(ArrayList<Medicine> meds, Context context) {
        this.meds = meds;
