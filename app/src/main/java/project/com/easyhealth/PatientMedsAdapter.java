 ...
 */
public class PatientMedsAdapter extends RecyclerView.Adapter<PatientMedsAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public PatientMedsAdapter(ArrayList<Medicine> meds, Context context) {
        this.meds = meds;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder,final int i) {
        ...
        viewHolder.del.setText("Set Reminder");
        if(c.getPatientid().compareToIgnoreCase(Global.patientid)==0){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.medicine_card, viewGroup, false);
